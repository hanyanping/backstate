                ...
                <div class="imgContent">
                    <div class="block">
                        <el-carousel
                            @change='changeBanner'
                            :autoplay='false'
                            :initial-index='indexnum'
                            arrow="always" indicator-position="none" trigger="click" height="174px" ref="carousel">
...
this.getBanner();
  ...
  methods: {
    ...
    changeBanner(index) {
      ...
      this.index = index;
      // this.id =
      this.getAdvers(this.photos[index].id)
    },
    open8(message) {
      this.$message({
        showClose: true,
    ...
    sureImg() {
      ...
      var id = this.photos[this.$refs.carousel.activeIndex].id;
      Service.advert()
        .editoradvert(
          {
            advertId: 1,
