                    ...
                    <el-tabs :tab-position="tabPosition" v-model="status" @tab-click="handleClick">
                        <el-tab-pane label="已发布文章">
                            <div class="searchbox">
                                ...
                                <div class="searchButton cursor" @click="editorBanner('new','healthvoice','')">新添文章</div>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tr v-for="(item,index) in tableData">
                                        ...
                                        <td>
                                            ...
                                            <img @click="editorBanner('editor','healthvoice',item.id)" @mouseenter="enterStyletwo(item)" @mouseleave='leaveStyletwo(item)' class='editorimg imgicon cursor' src="https://ifxj-upload.oss-cn-shenzhen.aliyuncs.com/ifxj_web_pc/bianji.png"/>
