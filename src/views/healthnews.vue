                    ...
                    <el-tabs v-if="noPermissions" :tab-position="tabPosition" v-model="status" @tab-click="handleClick">
                        <el-tab-pane label="已发布文章">
                            <div class="searchbox">
                                ...
                                <div class="searchButton cursor" v-if="(hasAdd<permissions.length)" @click="editorBanner('new','healthnews','')">新添文章</div>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tr v-for="(item,index) in tableData">
                                        ...
                                        <td v-if="(hasEditor<permissions.length) || (hasRemove<permissions.length)">
                                            ...
                                            <img v-if="hasEditor<permissions.length" @click="editorBanner('editor','healthnews',item.id)" @mouseenter="enterStyletwo(item)" @mouseleave='leaveStyletwo(item)' class='editorimg imgicon cursor' src="https://ifxj-upload.oss-cn-shenzhen.aliyuncs.com/ifxj_web_pc/bianji.png"/>
                                ...
                                <table class="table">
                                    ...
                                    <tr v-for="(item,index) in tableData">
                                        ...
                                        <td v-if="(hasPublish<permissions.length) || (hasDelete<permissions.length)">
                                            ...
                                            <img v-if="(hasPublish<permissions.length)" class="publishimg imgicon cursor" @click="publishArticle(item.id)" @mouseenter="enterStyleone(item)" @mouseleave='leaveStyleone(item)' src="https://ifxj-upload.oss-cn-shenzhen.aliyuncs.com/ifxj_web_pc/jinlingyingcaiwangtubiao97.png">
                                            <span class="deleteText warmtext" v-if="item.isDelete" >删除</span>
                                            <img v-if="(hasDelete<permissions.length)" class="deletimg imgicon cursor" @mouseenter="enterStylethree(item)" @mouseleave='leaveStylethree(item)' @click="deleteArticle(item.id)" src="https://ifxj-upload.oss-cn-shenzhen.aliyuncs.com/ifxj_web_pc/lajitong-2.png"/>
                                        </td>
                                    </tr>
                                </table>
                                <div class="block">
        ...
        methods:{
            ...
            searchAlready(){
                ...
                if(num<this.permissions.length){
                    ...
                    Service.article().getinquiry({page:this.page,size: this.size,categoryId:2,id:this.articleId,title: this.title,summary: this.summary,
